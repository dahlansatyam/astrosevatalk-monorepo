...
const TithiPakshaNashtra = (props: Props) => {
  return (
    <div>
      <div className="bg-[url('/horoscope-bg.svg')] bg-cover py-8 lg:py-[51px] flex flex-col gap-5">
        <div>
          <Section>
        ...
        <div>
          <Section>
            <div className="flex flex-col space-y-6 text-justify py-6">
            ...
            <div className="flex flex-col gap-2 px-4 py-2">
              ...
              <p>. Mars - Mrigashira, Chitra, and Dhanishta's lord.</p>
