...
function Textarea(props: any) {
  const { name, id, className, rows, placeholder, label, showTools, register } =
    props;
  return (
    <div className="mb-4 w-full bg-gray-50">
      {showTools ? (
        <div className="flex justify-between items-center py-2 px-3 border-b ">
          <div className="flex flex-wrap items-center divide-gray-200 sm:divide-x">
            <div className="flex items-center space-x-1 sm:pr-4">
              ...
              <button
                type="button"
                className="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 0"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
      ...
      <div className="bg-white rounded-b-lg">
        ...
        <textarea
          ...
          id={id}
          rows={rows}
          className={`${className} rounded-md block p-4 w-full text-sm text-gray-800 bg-white border  focus:outline-none focus:border-dark focus:ring-1 focus:ring-dark/30 h-32`}
