...
const VideochatConsult = (props: Props) => {
  return (
    <div>
          ...
          <div className="space-y-6">
            <div className="text-center font-[georgia] text-white">
              <h2 className="text-[32px] font-bold">
                How Video-Chat astrologers can help you?
              </h2>
            ...
            <p className="text-justify text-[20px] text-white">
              ...
              contact on chat and share with them your problems across all
              aspects of life including love, finance, Vastu, career, luck,
              marriage and so on. Simply put, life is a cocktail of highs and
              lows, and while we enjoy the good times, the bad times, though
              they teach us a lot, can also leave us worried, depressed and sad.
              Such times can also hamper the relationship we share with other
              people in our lives, and we are sure that you wouldn’t want that
              to happen for yourself.
              <br /> AstroSevatalk, with its exceptional astrology consultant
              ...
              solutions for you.
              <br /> At AstroSevatalk, we have a pool of learned astrologers
              with vast experience across various astrology domains like Vedic
              ...
              situation. AstroSevatalk provides you with the facility to chat
              with astrologer online free and paid in both ways. To find us
              online, you just need to search online chat with astrologer or
              free astro chat or chat with astrologer online free, talk to
              astrologer online, and chat with astrologer near me. The aim of
              our services is to give 100% satisfaction to the users. We offer
              you many free services as well like free kundali and match making.
            </p>
          </div>
        </Section>
      </div>
...
export default VideochatConsult;
